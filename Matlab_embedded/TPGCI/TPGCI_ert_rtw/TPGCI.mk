###########################################################################
## Makefile generated for component 'TPGCI'. 
## 
## Makefile     : TPGCI.mk
## Generated on : Tue Feb 18 20:15:14 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/TPGCI.exe
...
START_DIR                 = P:/inverter_test_matlab/TPGCI
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = TPGCI_comp.rsp
CMD_FILE                  = TPGCI.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/TPGCI.exe
...
DEFINES_STANDARD = -DMODEL=TPGCI -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/TPGCI_ert_rtw/TPGCI.c

MAIN_SRC = $(START_DIR)/TPGCI_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/TPGCI_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/TPGCI_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/TPGCI_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/TPGCI_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/TPGCI_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
TPGCI.obj : $(START_DIR)/TPGCI_ert_rtw/TPGCI.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.obj : $(START_DIR)/TPGCI_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
